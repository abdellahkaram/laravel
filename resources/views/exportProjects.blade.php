              ...
              <span class="col-md-1"></span>
                ...
                <h4>Project</h4>
                 <div>
                  ...
                  <div>
                  <a class="col-md-5 btn_submit text-center" href="#" id="selectOne" > Export Project Task </a>
                  <a class="col-md-5   col-md-offset-2  btn_submit text-center" href="/pdf"> Export Projects Information</a>
                </span>
            </div>
          </div>
...
<script>
    ...
    function change(id) {
           document.getElementById("selectOne").href="/pdftasks/"+id;
           //alert(num);
    }
