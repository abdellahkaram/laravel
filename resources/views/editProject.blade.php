...
<body>
        ...
        <div class="form-group">
				...
				{{ Form::text('name', $project->name , array('class' => 'form-control', 'required' => '', 'maxlength' => '255' )) }}
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          {{ Form::select('state', array('working_on'  => 'working_on', 'closed' => 'closed'), null, array('class' => 'form-control')) }}
        </div>


        {{ Form::reset('BACK', array('class' => 'col-md-3  btn_submit')) }}
				{{ Form::submit('Update Project', array('class' => 'col-md-7 col-md-offset-2  btn_submit')) }}
			{!! Form::close() !!}
