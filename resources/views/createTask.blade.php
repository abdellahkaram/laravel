...
<body>
    ...
    @include('nav') 
        ...
        {!! Form::open(array('route' => 'task.store', 'data-parsley-validate' => '' , 'class'=>'col-md-8 col-md-offset-2')) !!}
        ...
        {{ Form::label('state', 'state:'  ) }}
         {{ Form::select('state', array( 'planifie' => 'planifie' ,'encours' => 'encours' , 'compelte' => 'compelte' , 'annule' => 'annule'), null, array('class' => 'form-control')) }}
        </div>
        ...
        <div class="form-group">
         ...
         <div class="form-group">
                ...
                {{ Form::date('execution_date', \Carbon\Carbon::now()) , array('class' => 'form-control', 'required' => '' )  }}
        </div>

        <div class="form-group">
				{{ Form::label('delay', 'Delay:'  ) }}
				{{ Form::text('delay', null, array('class' => 'form-control', 'required' => '', 'maxlength' => '255' )) }}
        </div>


         <div class="form-group">
				{{ Form::label('project_id', 'project_id:'  ,  array('class' => 'hidden')  ) }}
				{{ Form::text('project_id', $coll['projectid'], array('class' => 'form-control  hidden', 'required' => '', 'maxlength' => '255'  )) }}
        </div>

        <div class="form-group" >
        <label>Assigned :</label>
            <select name="emp[]" class="form-control" multiple>
             @foreach (  $coll['users'] as $u)
        ...
        {{ Form::reset('BACK', array('class' => 'col-md-3  btn_submit')) }}
				{{ Form::submit('Create Task', array('class' => 'col-md-7 col-md-offset-2  btn_submit')) }}
			{!! Form::close() !!}
